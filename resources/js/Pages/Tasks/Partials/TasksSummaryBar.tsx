...
export default function TasksSummaryBar({
    ...
    return (
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md rounded-2xl border border-gray-100 dark:border-gray-700 p-4 sm:p-6 shadow-sm flex flex-col gap-3">
            ...
            {totalTaskCount > 0 && (
                <div className="w-full pt-3 border-t border-gray-100 dark:border-gray-700/60">
                    <div className="flex items-center justify-between text-xs mb-1.5 font-semibold">
                        <span className="text-gray-500 dark:text-gray-400">Overall Tasks Progress</span>
                        <span className={completedTaskCount > 0 ? "text-emerald-600 dark:text-emerald-400 font-bold" : "text-gray-500"}>
                            {overallProgress}% Completed
                        </span>
                    </div>
                    <div className="w-full bg-gray-200/90 dark:bg-gray-700/90 h-3 rounded-full overflow-hidden p-0.5 border border-gray-200/40 dark:border-gray-700/40 shadow-inner">
                        <div
