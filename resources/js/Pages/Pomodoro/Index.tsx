                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-center">
                    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md overflow-hidden shadow-sm sm:rounded-lg border border-gray-100 dark:border-gray-700 w-full max-w-lg p-8 flex flex-col items-center gap-8">
                        <div className="flex bg-gray-100 dark:bg-gray-900 rounded-lg p-1">
                            <button
                                className={`px-6 py-2 rounded-md font-medium transition cursor-pointer ${
                                    mode === 'focus'
                        ...
                        <div className="flex items-center gap-6">
                            <button
                                className="w-14 h-14 rounded-full flex items-center justify-center bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition cursor-pointer"
                                onClick={resetTimer}
                                title="Reset timer"
                            >
                                <RotateCcw size={24} />
                            ...
                            <button
                                className="w-20 h-20 rounded-full flex items-center justify-center bg-indigo-600 text-white shadow-lg shadow-indigo-200 dark:shadow-indigo-900/50 hover:bg-indigo-700 hover:scale-105 transition cursor-pointer"
                                onClick={toggleTimer}
                            ...
                            <button
                                className={`w-14 h-14 rounded-full flex items-center justify-center border transition cursor-pointer ${
                                    soundEnabled
